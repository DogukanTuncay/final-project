...
class OneSignalSegmentNotificationRequest extends BaseRequest
{
    /**
    ...
    {
        return [
            'segment.required' => 'Segment alanı zorunludur.',
            'segment.max' => 'Segment 255 karakterden uzun olamaz.',
            'user_ids.required' => 'Kullanıcı ID listesi zorunludur.',
            'user_ids.array' => 'Kullanıcı ID listesi bir dizi olmalıdır.',
            'user_ids.*.exists' => 'Geçersiz kullanıcı ID.',
